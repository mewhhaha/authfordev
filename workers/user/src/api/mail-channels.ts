...
type RoutesMailChannels = FetchDefinition<
	...
	BodyResponse<202> | BodyResponse<400> | BodyResponse<403> | BodyResponse<413> | JSONResponse<500, { errors: string[] }>
>;

export const mailChannels = (base: string) => fetcher<RoutesMailChannels>({ fetch: (...args) => fetch(...args) }, { base: base });
